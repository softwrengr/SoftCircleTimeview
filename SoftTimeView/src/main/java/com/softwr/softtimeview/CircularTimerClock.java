...
public class CircularTimerClock extends FrameLayout {
    ...
    public CircularTimerClock(@NonNull Context context, @Nullable AttributeSet attributeSet, @AttrRes int defStyleAtt) {
        super(context, attributeSet, defStyleAtt);

        this.context = context;
        this.attrs = attributeSet;
        this.defStyleAttr = defStyleAtt;
        ...
        clockView = new ClockView(context, attributeSet, defStyleAtt);
    ...
    public void init(int start, int end,float startMin, float endMin) {
        ...
        circularSliderView = new CircularSliderView(getContext(), attrs, defStyleAttr, start, end,startMin,endMin);
